...
const hubContent = {
  exhibitors: {
    ...
    primaryCta: { label: "Apply For Booth", href: "https://gesworldex.com/ep/ssiexb.php" },
    ...
    options: [
      {
        ...
        href: "https://gesworldex.com/ep/ssiexb.php",
        icon: ClipboardList,
        description:
      ...
      },
      {
        ...
        href: "https://gesworldex.com/ep/index.php",
        icon: BadgeCheck,
        description:
  ...
  visitors: {
    ...
    primaryCta: { label: "Register Interest", href: "https://gesworldex.com/ssidelhi" },
